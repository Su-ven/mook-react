...
import LogoImg from '../../images/logo.png'
 ...
 class MobileHeader extends React.Component{
 	...
 	handleSubmit(e){
 		...
 		fetch("http://newsapzi.gugujiankong.com/Handler.ashx?action=" + this.state.action + "&username="+formData.userName+"&password="+formData.password +"&r_userName=" + formData.r_userName + "&r_password="
