    ...
    return {
                    ...
                    switch (columns[i].render) {
                        ...
                        case "inUsingClientName":
                            columns[i].render = function (text, record) {
                                ...
                                const colorFlags = (<MenuColorFlag onClick={self.handleColorFlagClick.bind(this, record)}></MenuColorFlag>);
                        ...
                        case "inUsingMobile":
                            columns[i].render = function (text, record) {
                                ...
                                return <div style={{textAlign: 'center'}}>
                                            <BtnMobile to={text} fromList={self.state.managerTelephoneList} cid={record.customerId}
                        ...
                        case "spAccount":
                            columns[i].render = function (text, record) {
                                return <div>
                                    {record.metalSpAccount ? <div>津贵:{record.metalSpAccount}</div> : ""}
                                    {record.qiluSpAccount ? <div>齐鲁119:{record.qiluSpAccount}</div> : ""}
                                    {record.qilu159SpAccount ? <div>齐鲁159:{record.qilu159SpAccount}</div> : ""}
                                    {record.ydylSpAccount ? <div>一带一路:{record.ydylSpAccount}</div> : ""}
                                </div>;
                            }
                            break;
        ...
        refreshColumnsConfig(){
            let result = [
                ...
                {title: '最近回访内容', dataIndex: 'lastRevisitContent', sorter: true, width: 250, render: true},
                {title: '客户标签', dataIndex: 'tag', width: 150, render: "tag"},
                {title: '最近联系时间', dataIndex: 'lastOutgoingTime', sorter: true, width: 120, render: "lastOutgoingTime"},
                {title: '计划回访时间', dataIndex: 'plannedRevisitTime', sorter: true, width: 120, render: "plannedRevisitTime"},
                ...
                {title: '实盘帐号', dataIndex: 'spAccount', sorter: false, width: 150, render: "spAccount"},
            ];
