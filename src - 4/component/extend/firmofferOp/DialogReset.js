...
var form = React.createClass({
    ...
    handleSend(e){
        ...
        this.props.form.validateFields((errors, values) => {
            ...
            fluxAccount.actions.sendReset(params, (result) => {
    ...
    render() {
        ...
        const fieldProps = {
            ...
            // resetType: getFieldProps('resetType', {initialValue: '1'}),
        };
        ...
        let title = "申请重置密码【" + this.props.plat.name + "】实盘账号";
        return <Modal
            ...
            <Form form={this.props.form}>
                <Row>
                    ...
                    <Col span="12">
                        <FormItem {...formItemLayout}
                            label="客户姓名：">
                            <Input placeholder="请填写客户姓名" autoComplete="off" {...fieldProps["customerName"]}/>
                        </FormItem>
                    </Col>                    
                </Row>
                <Row>
