...
var form = React.createClass({
    ...
    handleSend(e){
        ...
        this.props.form.validateFields((errors, values) => {
            ...
            fluxAccount.actions.sendBigcontract(params, (result) => {
    ...
    render() {
        ...
        const fieldProps = {
            ...
            contractRatio: getFieldProps('contractRatio', {
                initialValue: "20",
                rules: [
                    {required: true, message: '请选择合约倍数'},
                ],
            }),            
        ...
        let title = "申请开通【" + this.props.plat.name + "】大合约";
        return <Modal
            ...
            <Form form={this.props.form}>
                ...
                <Row>
                    <Col span="12">
                        <FormItem {...formItemLayout} label="开通合约倍数：">
                            <Select {...fieldProps["contractRatio"]}>
