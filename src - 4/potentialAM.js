...
window._init_ = function (data, roles, ifOnDuty, config, portal) {
    ...
    let tag = ifOnDuty === true ? "onDuty" : ifOnDuty === false ? "notOnDuty" : "";
        ...
        <Route path="/" component={
            React.createClass({
                render: function() { return (
                    <Layout currentMenu="menu_0_0" menus={menus} userInfo={userInfo} sites={sites} addonSide={addon} tag={tag}>{this.props.children}</Layout>
                );}
            }) 
        }>
